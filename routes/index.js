  ...
  traerDataReservas().then((reservations)=> {
    ...
    for (let d = 0; d < dates.length; d++) {
      ...
      for (let i = 0; i < reservations.length; i++) {
        ...
        if(mes == dates[d]){
          cont = cont +1
          var start = new Date(reservations[i].start._seconds * 1000 + reservations[i].start._nanoseconds/1000)
          var end = new Date(reservations[i].end._seconds * 1000 + reservations[i].end._nanoseconds/1000) 
          ...
          var total = dnum-snum
          var dur = parseFloat((parseInt(total/60)+ (total%60)/60).toFixed(2))
...
router.get("/ageCustomers", function (req, res) {
  ...
  traerDataCustomer().then((customer) => {
    var ages = [0,0,0,0]
    for (let i = 0; i < customer.length; i++) {
      var date = new Date(customer[i].birthDate._seconds * 1000 + customer[i].birthDate._nanoseconds/1000)
...
router.get("/dayOrders", function (req, res) {
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      var date = new Date(orders[i].created._seconds * 1000 + orders[i].created._nanoseconds/1000)
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Bacata")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Macondo")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Lager")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Candelaria")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Chapinero")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Monserrate")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Septimazo")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
  ...
  traerDataOrdenes().then((orders) => {
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      for (let j = 0; j < a.length; j++) {
        ...
        var parts = item.split("|")
        var c = 0
        if (parts[0].includes("-") && !parts[0].includes("-BBC") && parts[0].includes("Cajica")){
          if(parts[0].includes("glass")){
            c = 0.33 * parseInt(parts[2])
          }
          if(parts[0].includes("pint")){
